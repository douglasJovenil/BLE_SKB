...
void enable_adc(void) {
    nrf_drv_timer_enable(&m_timer);
    nrf_ppi_channel_enable(m_ppi_channel);
}

void disable_adc(void) {
    nrf_drv_timer_disable(&m_timer);
    nrf_ppi_channel_disable(m_ppi_channel);
}